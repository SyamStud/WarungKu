...
const form = useForm({
    ...
    initialValues: {
        ...
        name: '',
        status: 'active',
        variantInputs: [{ quantity: '1', type: '1', price: '', cost: '', stock: '' }]
    },
});
...
onMounted(async () => {
    ...
    console.log(form.values.variantInputs[0].type);
});
...
// const variantInputs = ref([{ quantity: '', type: '', price: '', cost: '', stock: '' }]);

const addVariantInput = () => {
    const currentVariants = [...form.values.variantInputs];
    currentVariants.push({ quantity: '1', type: '1', price: '', cost: '', stock: '' });
                        ...
                        <div class="w-full">
                            <FormField v-slot="{ field }" name="category_id">
                                <FormItem>
                                    ...
                                    <Multiselect class="h-5" v-model="selectedCategories" :options="options"
                            ...
                            <div>
                                ...
                                <div class="w-max flex gap-1">
                                    ...
                                    <div class="min-w-max w-28 mt-2">
                                        <FormField v-slot="{ componentField }" :name="`variantInputs.${index}.type`">
                                            <FormItem>
                                                <Select v-model="input.type" v-bind="componentField"
                                                    @update:modelValue="(e) => updateVariantInput(index, 'type', e)">
                                                    <FormControl>
                                                        <SelectTrigger>
